  ...
  if (goal === 'Skincare & anti-aging') {
    ...
    if (hasRoutine && seenDerm) {
      return {
        ...
        levelLabel: 'Seen a Dermatologist + Have a Skincare Routine',
        headline: 'You’re Taking a Proactive Approach to Skin Health',
        body: 'Your answers show that you’re already investing in your skin with professional guidance and a consistent routine. That’s a great foundation for maintaining healthy-looking skin over time.\n\nMany people complement topical skincare with nutrients that support cellular processes linked to skin vitality. Add ChronoNAD+ to support cellular energy and long-term skin wellness.'
      }
    }
    ...
    if (hasRoutine && !seenDerm) {
      return {
        ...
        categoryLabel: 'SKINCARE / ANTI-AGING RESULTS',
        levelLabel: 'No Dermatologist + Yes Skincare Routine',
        headline: 'You’ve Started a Good Routine',
        body: 'Your answers show that you’ve built a skincare routine, which is an important step toward maintaining healthy-looking skin.\n\nHowever, skin health is influenced by both external care and internal cellular processes. Supporting your body at the cellular level may help maintain long-term skin vitality. Discover ChronoNAD+ to complement your skincare routine.'
      }
    }
    ...
    if (!hasRoutine && seenDerm) {
      return {
        ...
        categoryLabel: 'SKINCARE / ANTI-AGING RESULTS',
        levelLabel: 'Seen a Dermatologist + No Skincare Routine',
        headline: 'Professional Guidance Is a Strong Start',
        body: 'You’ve taken the right step with expert advice, but consistency can still be built over time. Supporting your skin internally can make a real difference.\n\nChronoNAD+ boosts NAD+ levels, helping with cellular repair, energy, and overall skin vitality. It’s an easy addition to complement your progress.'
      }
    }
    ...
    return {
      ...
      categoryLabel: 'SKINCARE / ANTI-AGING RESULTS',
      levelLabel: 'No Dermatologist + No Skincare Routine',
      headline: 'Your Skin May Need More Consistent Support',
      body: 'Your answers suggest you may not yet have a structured approach to supporting your skin. Daily habits, environmental exposure, and natural aging can impact how skin looks and feels over time.\n\nWhile topical care is important, skin health is also connected to what happens inside your cells. Support your skin from within with ChronoNAD+, formulated to support cellular energy and healthy aging.'
    }
  }
